    ...
    if (this.detailsForm.valid) {
      ...
      this.entitiesTableConfig.saveEntity(editingEntity, this.editingEntity)
        ...
        (entity) => {
          ...
          const entityTypeKey = this.translations?.type || 'entity.entity';
          const entityTypeName = this.translate.instant(entityTypeKey);
          const isNewEntity = !this.editingEntity || !this.editingEntity.id;
          const messageKey = isNewEntity ? 'entity.entity-created-successfully' : 'entity.entity-saved-successfully';
          this.store.dispatch(new ActionNotificationShow(
            {
              message: this.translate.instant(messageKey, {entityType: entityTypeName}),
              type: 'success',
              duration: 3000
            }));
